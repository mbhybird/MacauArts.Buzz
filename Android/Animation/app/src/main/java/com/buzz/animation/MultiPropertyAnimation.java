...
public class MultiPropertyAnimation extends Activity {
    ...
    public class MyAnimationView extends View implements ValueAnimator.AnimatorUpdateListener {
        ...
        public MyAnimationView(Context context) {
            ...
            addBall(150, 50, 0xff1DD5C0);
            addBall(250, 50, 0xff00A8A7);
            addBall(350, 50, 0xff698686);*/
            addBall(50, 50);
            addBall(150, 50);
            addBall(250, 50);
            addBall(350, 50);
        ...
        private ShapeHolder addBall(float x, float y) {
            ...
            int color = 0xff000000 | red << 16 | green << 8 | blue;//hexColor
            Paint paint = drawable.getPaint();
            int darkColor = 0xff000000 | red/4 << 16 | green/4 << 8 | blue/4;//hexColor
